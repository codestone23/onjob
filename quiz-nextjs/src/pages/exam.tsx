...
const Exam = () => {
  ...
  const [indexAnswer, setIndexAnswer] = useState<string | null>(
    ...
    <>
      ...
      <ContainerExam>
        <BodyExam>
          ...
          <QuestionExam>
            <TitleExam>
              Câu 3. Nhân viên chính thức của công ty Amela được nghỉ phép (có
              hưởng lương) bao nhiêu ngày một năm?
            </TitleExam>
            <AnswerExam>
              <ItemAnswer>
            ...
            <ButtonMove>
              <ButtonTransfer onClick={showModal}>Chuyển đến</ButtonTransfer>
            </ButtonMove>
          </QuestionExam>
        </BodyExam>
        <SiderExam>
